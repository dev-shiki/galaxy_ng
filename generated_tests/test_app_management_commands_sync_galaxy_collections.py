...
class TestSyncGalaxyCollections:
    ...
    def test_do_sync_dispatc():  # Return type: h(self):
        command = mock.MagicMock()
    ...
    def test_do_rebuild_dispatc():  # Return type: h(self):
        command = mock.MagicMock()
        repository = mock.MagicMock()
        namespace = 'test_namespace'
        name = 'test_name'
    ...
    def test_do_sync_dispatch_task_faile():  # Return type: d(self):
        command = mock.MagicMock()
        remote = mock.MagicMock()
        repository = mock.MagicMock()
        namespace = 'test_namespace'
    ...
    def test_do_rebuild_dispatch_task_faile():  # Return type: d(self):
        command = mock.MagicMock()
        repository = mock.MagicMock()
        namespace = 'test_namespace'
        name = 'test_name'
    ...
    def test_handle_rebuild_onl():  # Return type: y(self):
        command = mock.MagicMock()
        options = mock.MagicMock()
    ...
    def test_handle_limi():  # Return type: t(self):
        command = mock.MagicMock()
        options = mock.MagicMock()
        options['limit'] = 10
        command.handle(command, *[], **options)
