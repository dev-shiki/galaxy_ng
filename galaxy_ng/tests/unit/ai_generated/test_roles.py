...
def test_set_path_galaxy_versi__o():
    # test with different version
    set_path_galaxy_version(test_path, "1.0.1")
    result = get_path_galaxy_key(test_path, "version")
    assert result == "1.0.1"
    set_path_galaxy_version(test_path, "2.0.0")
    result = get_path_galaxy_key(test_path, "version")
    assert result == "2.0.0"

def test_set_path_galaxy_reposito__r():
    # Direct test of behavior with assertion on result
