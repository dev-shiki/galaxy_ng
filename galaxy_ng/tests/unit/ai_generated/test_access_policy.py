...
class TestAccessPolicyBase(TestCase):
    def setUp(self):  # Return type: # Return type self.user = models.User.objects.create_user("testuser):"
...
class TestLegacyAccessPolicy(TestCase):
    ...
    def test_is_namespace_owne():  # Return type: r(self):
        access_policy = LegacyAccessPolicy()
        self.assertTrue(access_policy.is_namespace_owner(self.view.request, self.view, "list"))