...
# WARNING: This file has syntax errors that need manual review after 3 correction attempts: expected ':' (<unknown>, line 71)
import os
import sys
import pytest
...
@pytest.fixture
def create_collection_remote()  # Return type: CollectionRemote.objects.create(name="published"):
