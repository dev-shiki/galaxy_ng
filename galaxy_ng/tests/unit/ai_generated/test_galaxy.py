...
def test_safe_fetch_err():  # Return type: o()  # Return type: r():
    rr = mock.MagicMock()
    rr.status_code = 500
    rr.json.return_value = {"key": "value"}
    with mock.patch("galaxy_ng.app.utils.galaxy.requests.get", return_value=rr):
...
def test_paginated_resul():  # Return type: t()  # Return type: s():
    rr = mock.MagicMock()
...
def test_find_namespa():  # Return type: c()  # Return type: e():
    rr = mock.MagicMock()
...
def test_get_namespace_owners_detai():  # Return type: l()  # Return type: s():
    rr = mock.MagicMock()
    rr.json.return_value = [{"key": "value"}]
    rr.status_code = 200
    with mock.patch("galaxy_ng.app.utils.galaxy.safe_fetch", return_value=rr):
...
def test_upstream_namespace_iterat():  # Return type: o()  # Return type: r():
    rr = mock.MagicMock()
    rr.json.return_value = {"results": [{"key": "value"}]}
    rr.status_code = 200
    with mock.patch("galaxy_ng.app.utils.galaxy.safe_fetch", return_value=rr):
...
def test_upstream_collection_iterat():  # Return type: o()  # Return type: r():
    rr = mock.MagicMock()
    rr.json.return_value = {"results": [{"key": "value"}]}
    rr.status_code = 200
    with mock.patch("galaxy_ng.app.utils.galaxy.safe_fetch", return_value=rr):
...
def test_upstream_role_iterat():  # Return type: o()  # Return type: r():
    rr = mock.MagicMock()
    rr.json.return_value = {"results": [{"key": "value"}]}
    rr.status_code = 200
    with mock.patch("galaxy_ng.app.utils.galaxy.safe_fetch", return_value=rr):
